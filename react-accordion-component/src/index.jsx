...
const topics = [
  {
    ...
    detail: `Hypertext Markup Language (HTML) is the standard markup language for
  ...
  },
  {
    ...
    detail: `Cascading Style Sheets (CSS) is a style sheet language used for describing
  ...
  },
  {
    id: 3,
    name: 'JavaScript',
    detail: `JavaScript, often abbreviated as JS, is a high-level interpreted programming
             language that conforms to ECMAScript specification. JavaScript has curly-bracket
